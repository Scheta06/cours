                    ...
                    <div class="form-section">
                        ...
                        <div class="form-grid">
                            ...
                            <div class="form-group full-width">
                                ...
                                <textarea id="product-description" rows="4" name="description" placeholder="Описание блок питания...">{{ old('description') }}</textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-grid">
                            <div class="form-group">
                                ...
                                <input type="number" name="power" id="cpu-cores" min="1" placeholder="500"
