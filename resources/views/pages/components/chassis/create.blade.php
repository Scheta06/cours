    ...
    <main class="main admin-page">
        <div class="container">
            ...
            <div class="breadcrumbs">
                ...
                <i class="fas fa-chevron-right"></i>
                <span>Новый корпус</span>
            </div>

            <h1 class="page-title">
                <i class="fas fa-microchip"></i> Создать корпус
            </h1>
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-grid">
                            ...
                            <div class="form-group full-width">
                                ...
                                <textarea id="product-description" rows="4" name="description" placeholder="Описание корпуса...">{{ old('description') }}</textarea>
                            </div>
                        </div>
                    </div>
